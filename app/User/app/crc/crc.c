/**
 * file name: crc.c
 * description: 实现CRC循环冗余校验的方法，查表法需要的表，最常用的表是CRC32 ？ 
 * author: 刘达毅
 * date: 2024/7/24
 * update: 来自CSDN
 **/
...
const struct CRC_INFO crc_struct[] = {
    ...
    //debug only
    {12, 0x111, 0x012, true,  true,   0x012},
    {12, 0x111, 0x012, false, false,  0x012},
};
...
/**
 * FUNC: crc_table_printf()
 * DESCRIPT: 打印CRC表
 * INPUT/OUTPUT: N/A
 * RETURN VALUE: void
 */
void crc_table_printf()
{
    const char* name[] = {
     "CRC4_ITU",
     "CRC5_EPC",
