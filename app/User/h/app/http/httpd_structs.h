...
/* added by ldy */
#define HTTP_HDR_JSGZ           HTTP_CACHE_CONTENT_TYPE_ENCODING("application/javascript", "gzip")
#define HTTP_HDR_CSSGZ          HTTP_CONTENT_TYPE_ENCODING("text/css", "gzip")
#define HTTP_HDR_ICOGZ          HTTP_CONTENT_TYPE_ENCODING("image/x-icon", "gzip")

static const tHTTPHeader g_psCustomHTTPHeaders[] = {
  { "js",   HTTP_HDR_JSGZ},
  { "css",  HTTP_HDR_CSSGZ},
  { "ico",  HTTP_HDR_ICOGZ}
};
#define NUM_HTTP_HEADERSGZ LWIP_ARRAYSIZE(g_psCustomHTTPHeaders)
/* end */
