...
WEB_DIR = SCRIPT_DIR              # 网页文件就在脚本同目录
OUTPUT_FILE  = SCRIPT_DIR / "web.bin"  # 输出文件路径
...
if __name__ == "__main__":
    ...
    # 目标路径：上一级目录
    dst_dir=os.path.join(os.path.dirname(OUTPUT_FILE), os.pardir)

    # 拷贝文件
    shutil.copy(OUTPUT_FILE, dst_dir)
